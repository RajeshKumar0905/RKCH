...
const FeedbackCard=({index,testimonial,name,desigination,company,image})=>(
...
<p className='mt-1 text-secondary text-[12px]'>{desigination}of {company}</p>
   </div>
...
<motion.div variants={textVariant()}>
  ...
  <h2 className={styles.heroHeadText}>Testimonals.</h2>
</motion.div>
     </div>
